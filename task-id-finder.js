...
;// ./task-id-finder.ts
var task_id_finder_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
const factory = (BaseBlockClass, widgetApi) => {
    return class MyTasksWidget extends BaseBlockClass {
        ...
        renderBlock(container) {
            return task_id_finder_awaiter(this, void 0, void 0, function* () {
          ...
          .${p}.${p}-limited::-webkit-scrollbar-thumb:hover{background:rgba(${primaryRgb},.55);background-clip:padding-box}` : "";
                ...
                function ensureCampaigns() {
                    return task_id_finder_awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            const r = yield fetch(`${baseUrl}/campaigns?limit=100&sort=title_ASC`, apiOpts());
                            if (!r.ok)
                                return;
                            const d = yield r.json();
                            const arr = Array.isArray(d) ? d : (d.data || d.campaigns || []);
                            for (const c of arr) {
        ...
        <style>
          ...
          .${p}-proof-badge{display:inline-flex;align-items:center;gap:3px;padding:3px 7px;border-radius:4px;font-size:10px;font-weight:700;letter-spacing:.3px;flex-shrink:0;text-transform:uppercase;background:rgba(217,119,6,.12);color:#B45309}
          .${p}-proof-badge svg{width:10px;height:10px}
      ...
      `;
                ...
                const idSearchEl = container.querySelector(`#${p}-idsearch`);
                if (idSearchEl)
                    idSearchEl.addEventListener("input", () => { idSearch = idSearchEl.value.trim(); renderList(); });
                const recurFilterEl = container.querySelector(`#${p}-recur-filter`);
                if (recurFilterEl)
                    recurFilterEl.addEventListener("change", () => { activeRecurrence = recurFilterEl.value; renderList(); });
                const prioFilterEl = container.querySelector(`#${p}-prio-filter`);
                if (prioFilterEl)
                    prioFilterEl.addEventListener("change", () => { activePriority = prioFilterEl.value; renderList(); });
      ...
      `;
        ...
        <div class="${p}-amodal-card">
          ...
          <div class="${p}-amodal-body" id="${p}-amodal-body-${instId}"></div>
                ...
                attModal.addEventListener("click", e => { if (e.target === attModal)
                    closeAttModal(); });
                aDl.addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                    if (!dlUrl)
                        return;
                    const name = dlName;
                    try {
        ...
        <div class="${p}-proof-card">
          ...
          <div class="${p}-proof-foot">
            ...
            <button type="button" class="${p}-proof-btn ${p}-proof-confirm" id="${p}-proof-confirm-${instId}" disabled>${tr("proofConfirm")}</button>
                ...
                proofModal.addEventListener("click", e => { if (e.target === proofModal)
                    closeProof(false); });
                pConfirm.addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
          ...
          <pre class="${p}-dbg-body"></pre>`;
                    ...
                    copyBtn.addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                ...
                function wireReassign(task) {
                    ...
                    const apply = () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                    ...
                    btn.addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                ...
                function notifyAssigned(userIds, groups, title) {
                    return task_id_finder_awaiter(this, void 0, void 0, function* () {
                        if (!notifyOnAssign)
                            return;
                        const send = (ids, text) => task_id_finder_awaiter(this, void 0, void 0, function* () {
                            if (!ids.length)
                                return;
                ...
                function metaCached(id) {
                    return task_id_finder_awaiter(this, void 0, void 0, function* () { if (mediaCache.has(id))
            ...
            <button type="button" class="${p}-att-x" data-id="${esc(id)}" title="Remove">${iXsmall}</button>
                ...
                function filteredTasks() {
                    return allTasks.filter(t => {
                        ...
                        if (activeRecurrence === "oneoff" && t.isRecurring)
                            return false;
                        if (activeRecurrence === "recurring" && !t.isRecurring)
                            return false;
          ...
          <label class="${p}-store-drop">
            ...
            <select class="${p}-store-select" id="${p}-store-select" aria-label="Store">
              ...
              ${[...instMap.entries()].map(([id, info]) => `<option value="${esc(id)}"${activeInstallFilter === id ? " selected" : ""}>${esc(info.title || id)} (${info.count})</option>`).join("")}
                    ...
                    const storeSel = storeTabs.querySelector(`#${p}-store-select`);
                    if (storeSel)
            ...
            ${esc(label)} <span style="opacity:.55;font-size:10px">${pct}</span>
                ...
                function renderTypeFilters() {
                    ...
                    const typeWrap = container.querySelector(`#${p}-type-wrap`);
                    if (typeWrap)
                        typeWrap.style.display = types.length ? "" : "none";
          ...
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
            ...
            ${showOtherAuditTasks ? `<div class="${p}-list" style="margin-top:8px">${ghostCards}</div>` : ""}`;
                ...
                function bindListEvents() {
                    ...
                    listWrap.querySelectorAll(`.${p}-copyid`).forEach((btn) => {
                        btn.addEventListener("click", (e) => task_id_finder_awaiter(this, void 0, void 0, function* () {
                            e.stopPropagation();
                            const el = btn;
                ...
                function ensureCompletionDates() {
                    return task_id_finder_awaiter(this, void 0, void 0, function* () {
                        ...
                        if (!done.length)
                            return;
                        yield Promise.all(done.map((t) => task_id_finder_awaiter(this, void 0, void 0, function* () {
                            try {
          ...
          ${legend}
                ...
                function renderTaskCard(task) {
                    ...
                    const proofBadge = requiresProof(task.description) ? `<span class="${p}-proof-badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>Proof</span>` : "";
          ...
          <div class="${p}-card ${isDone ? "done" : ""}" data-task-id="${esc(task.id)}" data-install-id="${esc(task.installationId)}">
            ...
            <div class="${p}-card-inner">
              ...
              <div class="${p}-card-body">
                <div class="${p}-card-top">${typeBadge}${recurBadge}${prioBadge}${proofBadge}</div>
          ...
          ${(pa === null || pa === void 0 ? void 0 : pa.notes) ? `<div class="${p}-detail-desc-label">${tr("notes")}</div><div class="${p}-detail-desc" style="margin-bottom:18px" dir="auto">${linkifyEscaped(esc(ct(pa.notes)), selfHost)}</div>` : ""}
        ...
        `;
          ...
          ${requiresProof(task.description) ? `<span class="${p}-proof-badge"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>Proof</span>` : ""}`;
        ...
        `;
                    ...
                    if (enableComments) {
                        ...
                        cFile === null || cFile === void 0 ? void 0 : cFile.addEventListener("change", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                        ...
                        const submit = () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                    ...
                    if (attAdd && attInput) {
                        ...
                        attInput.addEventListener("change", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                    ...
                    const _delBtn = detailEl.querySelector(`#${p}-detail-delete-${instId}`);
                    if (_delBtn) {
                        _delBtn.classList.remove("confirm");
                        _delBtn.textContent = "Delete task";
                        _delBtn.disabled = false;
                        _delBtn.dataset.armed = "";
                    }
                    const _arcBtn = detailEl.querySelector(`#${p}-detail-archive-${instId}`);
                    if (_arcBtn) {
                        _arcBtn.textContent = "Archive task";
                        _arcBtn.disabled = false;
                    }
                }
                overlayEl.addEventListener("click", closeDetail);
                detailClose.addEventListener("click", e => { e.stopPropagation(); closeDetail(); });
                const detailEdit = detailEl.querySelector(`#${p}-detail-edit-${instId}`);
                detailEdit === null || detailEdit === void 0 ? void 0 : detailEdit.addEventListener("click", e => { var _a; e.stopPropagation(); const t = detailTask; closeDetail(); if (t)
                    (_a = self._mtwOpenEdit) === null || _a === void 0 ? void 0 : _a.call(self, t); });
                const detailArchive = detailEl.querySelector(`#${p}-detail-archive-${instId}`);
                detailArchive === null || detailArchive === void 0 ? void 0 : detailArchive.addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                    if (!detailTask)
                        return;
                    const task = detailTask;
                    detailArchive.disabled = true;
                    detailArchive.textContent = "Archiving…";
                    try {
                        const res = yield fetch(`${baseUrl}/tasks/${task.installationId}/task/${task.id}/archive`, Object.assign({ method: "POST" }, apiOpts()));
                        if (!res.ok)
                            throw new Error(`HTTP ${res.status}`);
                        closeDetail();
                        hideBanner();
                        ...
                        showBanner("error", `Couldn't archive task: ${e.message}`);
                        detailArchive.disabled = false;
                        detailArchive.textContent = "Archive task";
                    }
                }));
                const detailDelete = detailEl.querySelector(`#${p}-detail-delete-${instId}`);
                let delArmT;
                detailDelete === null || detailDelete === void 0 ? void 0 : detailDelete.addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                    if (!detailTask)
                        return;
                    if (detailDelete.dataset.armed !== "1") {
                        detailDelete.dataset.armed = "1";
                        detailDelete.classList.add("confirm");
                        detailDelete.textContent = "Tap again to delete";
                        clearTimeout(delArmT);
                        delArmT = setTimeout(() => { detailDelete.dataset.armed = ""; detailDelete.classList.remove("confirm"); detailDelete.textContent = "Delete task"; }, 3000);
                        return;
                    }
                    clearTimeout(delArmT);
                    detailDelete.dataset.armed = "";
                    const task = detailTask;
                    detailDelete.disabled = true;
                    detailDelete.textContent = "Deleting…";
                    try {
                        const res = yield fetch(`${baseUrl}/tasks/${task.installationId}/task/${task.id}`, Object.assign({ method: "DELETE" }, apiOpts()));
                        if (!res.ok)
                            throw new Error(`HTTP ${res.status}`);
                        closeDetail();
                        hideBanner();
                        ...
                        showBanner("error", `Couldn't delete task: ${e.message}`);
                        detailDelete.disabled = false;
                        detailDelete.classList.remove("confirm");
                        detailDelete.textContent = "Delete task";
                    }
                }));
                ...
                detailToggle.addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                    if (!detailTask)
                        return;
                    const task = detailTask;
                    const isDone = task.status === "DONE" || task.status === "done" || task.status === "CLOSED";
                    ...
                    try {
                        ...
                        yield fetchUsers();
                        postEditComment(task, statusAction(task, newStatus, needProof));
                        renderDetailContent(task);
                ...
                function toggleTask(checkEl) {
                    return task_id_finder_awaiter(this, void 0, void 0, function* () {
                        ...
                        const needProof = !isDone && (requireProof || requiresProof((_pt === null || _pt === void 0 ? void 0 : _pt.description) || ""));
                        if (needProof && _pt) {
                            checkEl.style.pointerEvents = "none";
                            const ok = yield openProof(_pt);
                ...
                function translateSend(payload) {
                    return task_id_finder_awaiter(this, void 0, void 0, function* () {
                        ...
                        const r = yield fetch(`${baseUrl}/translations`, sessionOpts({
                            ...
                            body: JSON.stringify({ sourceLanguage: (/* inlined export .DEFAULT_LOCALE */"en_US"), targetLanguage: locale, contents: { value: payload } }),
                        }));
                        if (!r.ok)
            ...
            <div class="${p}-create-foot">
              ...
              <button type="button" class="${p}-btn-save" id="${p}-c-save">${editTask ? "Save changes" : tr("createTask")}</button>
                        ...
                        if (editTask) {
                            $("c-title").value = stripTypeTag(editTask.title || "");
                            $("c-desc").value = stripTypeTag(editTask.description || "");
                            const instEl = $("c-inst");
                            if (instEl) {
                                instEl.value = editTask.installationId;
                                if (instEl.tagName === "SELECT") {
                                    listSel.innerHTML = listOpts(editTask.installationId);
                            ...
                            if (curType && [...typeSel.options].some((o) => o.value === curType))
                        ...
                        $("c-save").addEventListener("click", () => task_id_finder_awaiter(this, void 0, void 0, function* () {
                            ...
                            let finalDesc = desc;
                            const campId = ($("c-campaign") || { value: "" }).value || "";
                            if (campId)
                                finalDesc = finalDesc ? `${finalDesc} [campaign: ${campId}]` : `[campaign: ${campId}]`;
                            const wantProof = ($("c-proof") || { checked: false }).checked;
                            if (wantProof)
                                finalDesc = finalDesc ? `${finalDesc} [proofreq]` : `[proofreq]`;
                            if (taskType)
                            ...
                            saveBtn.disabled = true;
                            saveBtn.textContent = editTask ? "Saving…" : tr("creating");
                            try {
                                if (editTask) {
                                    ...
                                    let editDesc = finalDesc;
                                    if (preserved)
                                        editDesc = editDesc ? `${editDesc} ${preserved}` : preserved;
                                    const body = { title, priority: prio, taskListId: listId, description: editDesc };
                                    if (due)
                                        body.dueDate = `${due}T00:00:00.000Z`;
                                    const r = yield fetch(`${baseUrl}/tasks/${editTask.installationId}/task/${editTask.id}`, Object.assign(Object.assign({ method: "PATCH" }, apiOpts()), { body: JSON.stringify(body) }));
                                    if (!r.ok)
                                        throw new Error(`HTTP ${r.status}`);
                                }
                                else {
                                ...
                                showBanner("error", `${(editTask ? "Couldn't save changes:" : tr("createFailedPrefix"))} ${e.message}`);
                                saveBtn.disabled = false;
                                saveBtn.textContent = editTask ? "Save changes" : tr("createTask");
                            }
                        }));
                    ...
                    self._mtwOpenEdit = (t) => openCreate(t);
                }
                load();
            });
        }
...
window.defineBlock({ blockDefinition, author: "Staffbase", version: "1.1.0" });
